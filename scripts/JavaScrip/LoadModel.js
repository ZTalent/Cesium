class LoadModel {
	...
	add44Model(lon,lat,height)
	{
		...
		for(var i=0;i<LELModelPath.length;i++)
		{
			...
			// var entity = $this.addStatic_Model(path,Cesium.Cartesian3.fromDegrees(LEL_lon, LEL_lat, LEL_height));
			// $this.LEL_modelArr.push(entity);
			...
			// 	var entity = $this.addStatic_Model(path,Cesium.Cartesian3.fromDegrees(LEL_lon, LEL_lat, LEL_height));
			// 	$this.changeAnegle(entity,LEL_heading,LEL_pitch,LEL_roll);
			// 	// $this.all_pipelineArr.push(entity);
			// 	$this.LEL_pipeline.push(entity);
			// }else{
			// 	var entity = $this.addStaticModel(path, LEL_lon, LEL_lat, LEL_height,LEL_heading,LEL_pitch,LEL_roll);
			// 	$this.LEL_modelArr.push(entity);
			// }
		}
	...
	addHYLModel(lon,lat,height)
	{
		...
		for(var i=0;i<HYLModelPath.length;i++)
		{
			...
			// if(flag)
			// {
			// 	var entity = $this.addStatic_Model(path,Cesium.Cartesian3.fromDegrees(HYL_lon, HYL_lat, HYL_height));
			// 	// $this.all_pipelineArr.push(entity);
			// 	$this.HYL_pipeline.push(entity);
			// 	$this.changeAnegle(entity,HYL_heading,HYL_pitch,HYL_roll);
			// }else{
			// 	var entity = $this.addStaticModel(path,HYL_lon, HYL_lat, HYL_height,HYL_heading,HYL_pitch,HYL_roll);
			// 	$this.HYL_modelArr.push(entity);
			// }
		}
	...
	addL17Model(lon,lat,height)
	{
		...
		for(var i=0;i<L17ModelPath.length;i++)
		{
			...
			// if(flag)
			// {
			// 	var entity = $this.addStatic_Model(path,Cesium.Cartesian3.fromDegrees(L17_lon, L17_lat, L17_height));
			// 	// $this.all_pipelineArr.push(entity);
			// 	$this.L17_pipeline.push(entity);
			// 	$this.changeAnegle(entity,L17_heading,L17_pitch,L17_roll);
			// }else{
			// 	var entity = $this.addStaticModel(path, L17_lon, L17_lat, L17_height,L17_heading,L17_pitch,L17_roll);
			// 	$this.L17_modelArr.push(entity);
			// }
		}
	...
	addWDZModel(lon,lat,height)
	{
		...
		for(var i=0;i<WDZModelPath.length;i++)
		{
			...
			// if(flag)
			// {
			// 	var entity = $this.addStatic_Model(path,Cesium.Cartesian3.fromDegrees(WDZ_lon, WDZ_lat, WDZ_height));
			// 	// $this.all_pipelineArr.push(entity);
			// 	$this.WDZ_pipeline.push(entity);
			// 	$this.changeAnegle(entity,WDZ_heading,WDZ_pitch,WDZ_roll);
			// }else{
			// 	var entity = $this.addStaticModel(path, WDZ_lon, WDZ_lat, WDZ_height,WDZ_heading,WDZ_pitch,WDZ_roll);
			// 	$this.WDZ_modelArr.push(entity);
			// }
		}
	...
	addWSLModel(lon,lat,height)
	{
		...
		for(var i=0;i<WSLModelPath.length;i++)
		{
			...
			// if(flag)
			// {
			// 	var entity = $this.addStatic_Model(path,Cesium.Cartesian3.fromDegrees(WSL_lon, WSL_lat, WSL_height));
			// 	// $this.all_pipelineArr.push(entity);
			// 	$this.WSL_pipeline.push(entity);
			// 	$this.changeAnegle(entity,WSL_heading,WSL_pitch,WSL_roll);
			// }else{
			// 	var entity = $this.addStaticModel(path, WSL_lon, WSL_lat, WSL_height,WSL_heading,WSL_pitch,WSL_roll);
			// 	$this.WSL_modelArr.push(entity);
			// }
		}
