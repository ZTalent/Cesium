...
// 			// 		// var totalAngle = Angle(points[j],points[0],points[k]);
// 			// 		// var dis_temp1 = distance(positions[0], positions[j]);
// 			// 		// var dis_temp2 = distance(positions[0], positions[k]);
...
// 		         prevLng = lng;
// 		     }
// 		     return Math.abs(total * (radius * radius)).toFixed(4);
// 		   }
