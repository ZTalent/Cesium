...
// 					m_circle_info.push((circle_area).toFixed(6));
		...
		calculateCircle(viewer,handler){
				...
				var HeightLinePrimitive = (function () {
					 ...
					 _.prototype._init = function () {
						...
						// 	var curPosition = Cesium.Ellipsoid.WGS84.cartesianToCartographic(_self.positions[0]);
						// 	var lon = curPosition.longitude * 180 / Math.PI;
						// 	var lat = curPosition.latitude * 180 / Math.PI;
						// 	var carto=new Cesium.Cartographic.fromDegrees(lon,lat);
						// 	var height = this.viewer.scene.sampleHeight(carto);
						// 	// var height_temp = _self._circle_height;
						// 	console.log(height);
						// 	return height;
						// }
